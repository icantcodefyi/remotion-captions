 ...
 */
export function SafeZoneOverlay({ aspectId }: Props) {
...
function Band({ style, label, anchor = "top" }: BandProps) {
  return (
    <div
      ...
      style={{
        ...
        borderTop:
          anchor === "bottom" ? "1px dashed rgba(255,255,255,0.28)" : undefined,
        borderBottom:
          anchor === "top" ? "1px dashed rgba(255,255,255,0.28)" : undefined,
      }}
    >
      <span
